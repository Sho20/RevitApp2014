...
namespace CollectorExts
{
	...
	public abstract class CollectorExt
	{
		...
		CollectorExt()
		{
            ...
            CollectorExts.Collector.OnCollectorExt += new CollectorExts.Collector.CollectorExt(CollectEvent);
        ...
        CollectEvent(object sender, CollectorExts.CollectorEventArgs e);
